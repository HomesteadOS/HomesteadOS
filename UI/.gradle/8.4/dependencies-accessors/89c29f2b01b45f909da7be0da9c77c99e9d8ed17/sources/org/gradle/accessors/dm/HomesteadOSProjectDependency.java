...
@NonNullApi
public class HomesteadOSProjectDependency extends DelegatingProjectDependency {

    @Inject
    public HomesteadOSProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
